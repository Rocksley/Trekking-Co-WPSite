...
function gpr_activation_admin_notice() {
	...
	if ( $pagenow == 'plugins.php' && ! get_user_meta( $user_id, 'gpr_activation_ignore_notice' ) ) { ?>
		...
		<div class="updated gpr">
			<header>
				<img src="<?php echo GPR_PLUGIN_URL; ?>/assets/images/google-logo-medium.png" class="gpr-logo"/>
				<h3><?php _e( 'Thank you for installing the free version of Google Places Reviews', 'google-places-reviews' ); ?></h3>
					...
					<div id="mc_embed_signup">
						...
						<form action="//wordimpress.us3.list-manage.com/subscribe/post?u=3ccb75d68bda4381e2f45794c&amp;id=cf1af2563c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							<div class="mc-field-group">
								<p>
									<small><?php _e( 'Get notified of plugin updates:', 'google-places-reviews' ); ?></small>
								</p>
