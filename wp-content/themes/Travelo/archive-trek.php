...
if ( is_tax() ) {
	...
	if ( $queried_term_obj ) {
		if ( ( $queried_taxonomy == 'trek_type' ) && ( ! in_array( $queried_term_obj->term_id, $acc_type ) ) ) $acc_type[] = $queried_term_obj->term_id;
			...
			<div class="row">
				<div class="col-sm-4 col-md-3">
					...
					<div class="toggle-container style1 filters-container">
						...
						<div class="panel style1 arrow-right">
							<h4 class="panel-title">
								<a data-toggle="collapse" href="#trek-type-filter" class="<?php echo empty( $acc_type )?'collapsed':''?>"><?php _e( 'Trek Type', 'trav' ) ?></a>
							</h4>
							<div id="trek-type-filter" data-url-noacc_type="<?php echo esc_url( remove_query_arg( array( 'acc_type', 'page' ) ) ); ?>" class="panel-collapse collapse <?php echo empty( $acc_type )?'':'in'?>">
								<div class="panel-content">
									<ul class="check-square filters-option">
										<?php
											...
											$all_acc_types = get_terms( 'trek_type', array('hide_empty' => 0) );
				...
				<div class="col-sm-8 col-md-9">
					...
					<?php } else { ?>
						<div class="travelo-box"><?php _e( 'No available treks', 'trav' );?></div>
					<?php } ?>
				</div>
			</div>
		</div>
