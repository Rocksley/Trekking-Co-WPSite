...
require_once( TRAV_INC_DIR . '/frontend/trek/functions.php');
require_once( TRAV_INC_DIR . '/frontend/trek/templates.php');
require_once( TRAV_INC_DIR . '/frontend/trek/ajax.php');
