...
if ( !class_exists( 'RWMB_Select_Advanced_Field' ) )
{
	class RWMB_Select_Advanced_Field extends RWMB_Select_Field
	{
		...
		{
			wp_enqueue_style( 'rwmb_select2', RWMB_CSS_URL . 'select2/select2.css', array(), '3.2' );
			wp_enqueue_style( 'rwmb-select-advanced', RWMB_CSS_URL . 'select-advanced.css', array(), RWMB_VER );

			wp_register_script( 'rwmb_select2', RWMB_JS_URL . 'select2/select2.min.js', array(), '3.2', true );
			wp_enqueue_script( 'rwmb-select-advanced', RWMB_JS_URL . 'select-advanced.js', array( 'rwmb_select2' ), RWMB_VER, true );
		}
