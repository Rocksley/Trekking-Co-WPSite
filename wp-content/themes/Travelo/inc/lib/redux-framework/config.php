<?php
	...
	Redux::setSection( $opt_name, array(
		'title'      => __( 'Trek Main Settings', 'trav' ),
		'id'         => 'trek-main-settings',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'disable_acc',
				'type'     => 'button_set',
				'title'    => __('Enable/Disable trek feature.', 'trav'),
				'default'  => 0,
				'options'  => array(
					'0' => __( 'Enable', 'trav' ),
					'1' => __( 'Disable', 'trav' )
			...
			array(
				...
				'title'    => __('Trek Booking Page', 'trav'),
				'subtitle' => __('This sets the base page of your trek booking.', 'trav'),
				'options'  => $options_pages,
			),
			array(
				...
				'type'     => 'select',
				'required' => array( 'disable_acc', '=', '0' ),
				'title'    => __('Trek Booking Confirmation Page', 'trav'),
				'subtitle' => __('This sets the trek booking confirmation page.', 'trav'),
				'options'  => $options_pages,
			),
			array(
				'id'       => 'terms_page',
			...
			array(
				...
				'type'     => 'text',
				'required' => array( 'disable_acc', '=', '0' ),
				'title'    => __( 'Treks per page', 'trav' ),
				'subtitle' => __( 'Select a number of treks to show on Search Trek Result Page', 'trav' ),
				'default'  => '12',
			),
			array(
	...
	if ( ! empty( $acc_add_on_settings ) ) {
		Redux::setSection( $opt_name, array(
			'title'      => __( 'Trek Add-On Settings', 'trav' ),
			'id'         => 'trek-add-settings',
			'subsection' => true,
	...
	Redux::setSection( $opt_name, array(
		'title'      => __( 'Trek Email Settings', 'trav' ),
		'id'         => 'trek-email-settings',
		'subsection' => true,
		'fields'     => array(
			array(
			...
			array(
				...
				'subtitle' => __( 'Trek booking confirmation email subject.', 'trav' ),
				'id' => 'acc_confirm_email_subject',
				'default' => 'Your booking at [trek_name]',
				'type' => 'text'),
			array(
				'title' => __('Booking Confirmation Email Description', 'trav'),
				'subtitle' => __( 'Trek booking confirmation email description.', 'trav' ),
			...
			array(
				...
				'subtitle' => __( 'Trek update booking email subject.', 'trav' ),
				'id' => 'acc_update_email_subject',
				'default' => 'Your booking at [trek_name] is now updated.',
				'type' => 'text'),
			array(
				'title' => __('Update Booking Email Description', 'trav'),
				'subtitle' => __( 'Trek update booking email description.', 'trav' ),
			...
			array(
				...
				'subtitle' => __( 'Trek cancel booking email subject.', 'trav' ),
				'id' => 'acc_cancel_email_subject',
				'default' => 'Your booking at [trek_name] is now canceled.',
				'type' => 'text'),
			array(
				'title' => __('Cancel Booking Email Description', 'trav'),
				'subtitle' => __( 'Trek cancel booking email description.', 'trav' ),
			...
			array(
				...
				'subtitle' => __( 'Administrator Notification Email Subject for Trek Booking.', 'trav' ),
				'id' => 'acc_admin_email_subject',
				'default' => 'Received a booking at [trek_name]',
				'required' => array( 'acc_booked_notify_admin', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Administrator Booking Notification Email Description', 'trav'),
				'subtitle' => __( 'Administrator Notification Email Description for Trek Booking.', 'trav' ),
			...
			array(
				...
				'subtitle' => __( 'Administrator notification email subject for trek booking update.', 'trav' ),
				'id' => 'acc_update_admin_email_subject',
				'default' => 'A booking at [trek_name] is updated.',
				'required' => array( 'acc_booked_notify_admin', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Administrator Booking Update Notification Email Description', 'trav'),
				'subtitle' => __( 'Administrator notification email description for trek booking update.', 'trav' ),
			...
			array(
				...
				'subtitle' => __( 'Administrator notification email subject for trek booking cancel.', 'trav' ),
				'id' => 'acc_cancel_admin_email_subject',
				'default' => 'A booking at [trek_name] is canceled.',
				'required' => array( 'acc_booked_notify_admin', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Administrator Booking Cancel Notification Email Description', 'trav'),
				'subtitle' => __( 'Administrator notification email description for trek booking cancel.', 'trav' ),
			...
			array(
				...
				'type'     => 'section',
				'title'    => __( 'Trek Onwer Notification Setting', 'trav' ),
				// 'subtitle' => __( '', 'trav' ),
				'indent'   => true,
			),
			array(
				'title' => __('Trek Owner Notification', 'trav'),
				'subtitle' => __('enable individual booked email notification to trek owner.', 'trav'),
				'id' => 'acc_booked_notify_bowner',
				'default' => 'true',
				'type' => 'switch'),
			array(
				'title' => __('Trek Owner Notification Email Subject', 'trav'),
				'subtitle' => __( 'Trek Owner Notification Email Subject for Trek Booking.', 'trav' ),
				'id' => 'acc_bowner_email_subject',
				'default' => 'Received a booking at [trek_name]',
				'required' => array( 'acc_booked_notify_bowner', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Trek Owner Notification Email Description', 'trav'),
				'subtitle' => __( 'Trek Owner Notification Email Description for Trek Booking.', 'trav' ),
				'id' => 'acc_bowner_email_description',
				'default' => file_get_contents( dirname( __FILE__ ) . '/templates/acc_bowner_email_description.htm' ),
				'required' => array( 'acc_booked_notify_bowner', '=', '1' ),
				'type' => 'editor'),
			array(
				'title' => __('Trek Owner Booking Update Notification Email Subject', 'trav'),
				'subtitle' => __( 'Trek Owner notification email subject for trek booking update.', 'trav' ),
				'id' => 'acc_update_bowner_email_subject',
				'default' => 'A booking at [trek_name] is updated.',
				'required' => array( 'acc_booked_notify_bowner', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Trek Owner Booking Update Notification Email Description', 'trav'),
				'subtitle' => __( 'Trek Owner notification email description for trek booking update.', 'trav' ),
				...
				'type' => 'editor'),
			array(
				'title' => __('Trek Owner Booking Cancel Notification Email Subject', 'trav'),
				'subtitle' => __( 'Trek Owner notification email subject for trek booking cancel.', 'trav' ),
				'id' => 'acc_cancel_bowner_email_subject',
				'default' => 'A booking at [trek_name] is canceled.',
				'required' => array( 'acc_booked_notify_bowner', '=', '1' ),
				'type' => 'text'),
			array(
				'title' => __('Trek Owner Booking Cancel Notification Email Description', 'trav'),
				'subtitle' => __( 'Trek Owner notification email description for trek booking cancel.', 'trav' ),
