...
$acc_type_terms = get_terms( 'trek_type', array( 'hide_empty' => false ) );
$acc_types = array( __( "All", "trav" ) => "" );
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"type" => "textfield",
			"class" => "",
			"heading" => __("Count of Treks", 'trav'),
			"param_name" => "count",
			"value" => "10",
			"description" => ""
		),
		...
		array(
			"type" => "textfield",
			"class" => "",
			'heading' => __( 'Trek IDs', 'trav' ),
			"param_name" => "post_ids",
			"description" => __( "Fill this field with Trek IDs separated by commas. ", "trav" ),
			"dependency" => array(
				"element" => "type",
...
vc_add_params("treks", $add_css3_animation);
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "post_ids",
			"description" => __( "Fill this field with Tour IDs separated by commas. ", "trav" ),
			"dependency" => array(
				"element" => "type",
				"value" => array("selected")
			)
...
add_filter('vc_shortcodes_css_class', 'trav_vc_shortcode_css_class', 10, 3);