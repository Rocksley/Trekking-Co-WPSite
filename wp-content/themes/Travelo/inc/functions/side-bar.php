...
if ( ! function_exists( 'trav_register_sidebar' ) ) {
	function trav_register_sidebar() {
		...
		$args = array(
			'name'          => __( 'Trek Sidebar', 'trav' ),
			'id'            => 'sidebar-acc-detail',
			'description'   => 'It will be shown on the trek detail page',
			'class'         => '',
			'before_widget' => '<div id="%1$s" class="widget travelo-box %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widgettitle">',
		...
		$args = array(
			'name'          => __( 'Travel Package Sidebar', 'trav' ),
			'id'            => 'sidebar-tg',
			'description'   => 'Single Travel Package Default Sidebar',
			'class'         => '',
			'before_widget' => '<div id="%1$s" class="widget travelo-box %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widgettitle">',
