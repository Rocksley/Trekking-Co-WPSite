...
/*
 * get sibling trek id in original language
 */
if ( ! function_exists( 'trav_acc_org_id' ) ) {
	function trav_acc_org_id($id) {
		return trav_get_default_language_post_id( $id, 'trek' );
	}
}

/*
 * get sibling trek id in current language
 */
if ( ! function_exists( 'trav_acc_clang_id' ) ) {
	function trav_acc_clang_id($id) {
		return trav_get_current_language_post_id( $id, 'trek' );
	}
}
