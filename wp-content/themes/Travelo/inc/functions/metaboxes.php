	...
	function trav_register_acc_meta_boxes() {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				array(
					'name'  => __( 'Type', 'trav' ),
					'id'      => "{$prefix}trek_types",
					'desc'  => __( 'Select an trek type', 'trav' ),
					'placeholder'  => __( 'Select an trek type', 'trav' ),
					'type'  => 'taxonomy',
					'options' => array(
						'taxonomy' => 'trek_type',
						'type' => 'select_advanced',
				...
				array(
					...
					'desc'  => __( 'If this trek doesn\'t have rating then leave it 0' , 'trav' ),
					'type' => 'slider',
					'suffix' => __( ' star', 'trav' ),
					'std'  => 0,
					'js_options' => array(
				...
				array(
					...
					'desc'  => __( 'Leave it blank if this trek does not have minimum stay', 'trav' ),
					'type'  => 'number',
					'suffix'=> 'Nights'
				),
				array(
				...
				array(
					'name'  => __( 'Trek Brief', 'trav' ),
					'id'      => "{$prefix}brief",
					'desc'  => __( 'This is trek brief field and the value is shown on search result page and detail page .', 'trav' ),
					'type'  => 'textarea',
				),
			)
		);
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					...
					'id'      => "{$prefix}ttd",
					'desc'  => __( 'Please select a city first and then save trek. Then things to do list in the city will be shown.', 'trav' ),
					'type'  => 'post',
				...
				array(
					'name'  => __( 'Travel Package', 'trav' ),
					'id'      => "{$prefix}tg",
					'type'  => 'post',
					'post_type' => 'travel_package',
					'placeholder' => __( 'Select a Travel Package', 'trav' ),
					'field_type' => 'select_advanced',
					'multiple' => false,
				),
			)
		...
		$meta_boxes[] = array(
			...
			/*
				...
				array(
					'name'  => __( 'Cards accepted at this trek', 'trav' ),
					'id'      => "{$prefix}cards",
					'type'  => 'textarea',
				),
				array(
		...
		$meta_boxes[] = array(
			'id' => 'trek_settings',
			'title' => __( 'Trek Settings', 'trav' ),
			'pages' => array( 'trek' ),
			'context' => 'side',
			'priority' => 'default',
			'fields' => array(
				array(
					'name' => __( 'Feature This Trek', 'trav' ),
					'id'    => "{$prefix}featured",
					'desc' => __( 'Add this trek to featured list.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
					'name' => __( 'Discount This Trek', 'trav' ),
					'id' => "{$prefix}hot",
					'desc' => __( 'Add this trek to hot list.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
				...
				array(
					...
					'desc' => __( 'Disable edit booking for this trek on confirmation page.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
					...
					'desc' => __( 'Disable cancel booking for this trek on confirmation page.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
			)
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				array(
					'name'  => __( 'Type', 'trav' ),
					'id'      => "{$prefix}types",
					'desc'  => __( 'Select an tour type', 'trav' ),
					'placeholder'  => __( 'Select an tour type', 'trav' ),
					'type'  => 'taxonomy',
					'options' => array(
						'taxonomy' => 'tour_type',
						'type' => 'select_advanced',
...
/*
 * travel package metabox registration
 */
if ( ! function_exists( 'trav_register_tg_meta_boxes' ) ) {
	function trav_register_tg_meta_boxes() {
		...
		$meta_boxes[] = array(
			'id'          => 'trav_tg_detail',
			'title'       => __( 'Travel Package Detail', 'trav' ),
			'description' => __( 'Enter Travel Package Detail.', 'trav' ),
			'pages'        => array('travel_package'),
			'context'     => 'normal',
			'priority'    => 'high',
			'fields'      => array(
				array(
					'name' => __( 'Trip Overview', 'trav' ), // Rob here
					'id'   => "{$prefix}g_info",
					'type' => 'wysiwyg',
					'raw'  => true,
					'std'  => '',
				...
				array(
					'name' => __( 'Trip Details', 'trav' ), // Rob here
					'id'   => "{$prefix}sports",
					'type' => 'wysiwyg',
					'raw'  => true,
					'std'  => '',
				...
				array(
					'name' => __( 'Useful Information', 'trav' ),  // Rob here
					'id'   => "{$prefix}culture",
					'type' => 'wysiwyg',
					'raw'  => true,
					'std'  => '',
...
/*
 * Register room types meta box on trek page
 */
if ( ! function_exists( 'trav_trek_rooms_meta_box' ) ) {
	function trav_trek_rooms_meta_box( $post )
	{
		add_meta_box( 
			'trav_trek_rooms_meta_box', // this is HTML id
			'Room Types in This Trek', 
			'trav_trek_rooms_meta_box_html', // the callback function
			'trek', // register on post type = page
			'side', // 
			'default'
		);
	}
...
/*
 * room types meta box HTML on trek page
 */
if ( ! function_exists( 'trav_trek_rooms_meta_box_html' ) ) {
	function trav_trek_rooms_meta_box_html( $post )
	{
		if ( isset( $_GET['post'] ) ) {
			$acc_id = $_GET['post'];
			$args = array(
			...
			if ( ! empty( $room_types ) ) {
				...
				echo 'No Room Types in This Trek. <br />';
			}
...
add_action( "add_meta_boxes", "trav_trek_rooms_meta_box" );
