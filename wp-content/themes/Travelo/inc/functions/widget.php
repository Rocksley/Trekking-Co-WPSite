...
class TravSocialLinksWidget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		<li class="dribble"><a title="dribble" href="<?php echo esc_url( $instance['dribbble_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fa fa-wechat"></i></a></li>
		<?php endif; ?>
...
class TravSimilarAccWidget extends WP_Widget {
	...
	function __construct() {
		parent::__construct( false, 'Travelo Similar Treks' );
	}
	...
	function widget($args, $instance) {
		...
		echo do_shortcode('[similar_treks count="' . $count . '"]' );
