...
class TravShortcodes {
	...
	* **************************************************************** */
	...
	/* ***************************************************************
	* **************** Trek Booking Page Shortcode **********
	* **************************************************************** */
	function shortcode_trek_booking( $atts, $content = null ) {
		ob_start();
		trav_get_template( 'trek-booking.php', '/templates/trek' );
	...
	/* ***************************************************************
	* ******* Trek Booking Confirmation Page Shortcode ******
	* **************************************************************** */
	function shortcode_trek_booking_confirmation( $atts, $content = null ) {
		ob_start();
		trav_get_template( 'trek-booking-confirmation.php', '/templates/trek' );
		$output = ob_get_contents();
		ob_end_clean();
		return $output;
	}
	...
	* **************************************************************** */
	...
	/* ***************************************************************
	* **************** Similar Treks Shortcode **************
	* **************************************************************** */
	function shortcode_similar_treks( $atts ) {
		extract( shortcode_atts( array(
			// 'title' => __( 'Similar Treks', 'trav' ),
			'count' => 3,
			'class' => '',
			'thumb_width' => 64,
			'thumb_height' => 64,
	...
	* **************************************************************** */
	function shortcode_search_form( $atts, $content = null ) {
		...
		$def_post_types = array( 'post', 'trek', 'tour' );
		...
		ob_start();
		if ( $post_type == 'trek' && empty( $content ) ) { ?>
			<?php if ( $style == 'style2' ) : ?>
