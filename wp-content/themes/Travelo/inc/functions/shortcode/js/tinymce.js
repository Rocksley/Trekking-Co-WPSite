      ...
      menu  : [
        ...
        { text: 'Pages & Lists',
          menu : [
             ...
             { text : 'Trek Booking Page', onclick: function() {editor.insertContent('[trek_booking]');} },
             { text : 'Trek Booking Confirmation Page', onclick: function() {editor.insertContent('[trek_booking_confirmation]');} },
             { text : 'Treks', onclick: function() {editor.insertContent('[treks title="", (type="latest|featured|popular|hot|selected") (style="style1|style2|style3|style4") (count="10") (city="" country="") (post_ids="") ]');} },
             { text : 'Similar Treks', onclick: function() {editor.insertContent('[similar_treks (count="3") (thumb_width="64") (thumb_height="64")]');} },
