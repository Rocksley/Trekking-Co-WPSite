	...
	<div class="sidebar col-sms-6 col-sm-4 col-md-3">
		<div class="booking-details travelo-box">
			...
			<article class="image-box hotel listing-style1">
				<figure class="clearfix">
					<a href="<?php echo esc_url( $acc_url ); ?>" class="hover-effect middle-block">
						<?php echo get_the_post_thumbnail( $booking_data['trek_id'], 'thumbnail', array( 'class'=>'middle-item' ) ); ?>
					</a>
					<div class="travel-title">
						<h5 class="box-title"><a href="<?php echo esc_url( $acc_url ); ?>"><?php echo esc_html( get_the_title( $booking_data['trek_id'] ) );?></a>
							<small>
								<?php echo esc_html( trav_acc_get_city( $booking_data['trek_id'] ) ); ?>
								<br />
								<?php echo esc_html( trav_acc_get_country( $booking_data['trek_id'] ) ); ?>
							</small>
						</h5>
				...
				<div class="details">
					<div class="feedback">
						...
						<span class="review"><?php echo esc_html( trav_get_review_count( $booking_data['trek_id'] ) . ' ' .  __('reviews', 'trav') ); ?></span>
					</div>
					<div class="constant-column-3 timing clearfix">
						<div class="check-in">
							<label><?php _e( 'Check in', 'trav'); ?></label>
							<span><?php echo date( "M j, Y", trav_strtotime( $booking_data['date_from'] ) );?><br /><?php $date_from_time = get_post_meta( $booking_data['trek_id'], 'trav_trek_check_in', true ); if ( isset($date_from_time) ) echo esc_html( $date_from_time );?></span>
						</div>
						...
						<div class="check-out">
							...
							<span><?php echo date( "M j, Y", trav_strtotime( $booking_data['date_to'] ) );?><br /><?php $date_to_time = get_post_meta( $booking_data['trek_id'], 'trav_trek_check_out', true ); if ( isset($date_to_time) ) echo esc_html( $date_to_time );?></span>
						</div>
					</div>
					<div class="guest">
			...
			<dl class="price-details clearer">
				<?php
					if ( is_array( $room_price_data['check_dates'] ) ) :
