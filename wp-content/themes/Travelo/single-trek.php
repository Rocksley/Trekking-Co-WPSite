		...
		<section id="content">
			<div class="container">
				<div class="row">
						...
						<div id="hotel-features" class="tab-container">
							<ul class="tabs">
								...
								<?php if ( ! empty( $acc_meta['trav_trek_faq'] ) ) : ?>
									<li><a href="#hotel-faqs" data-toggle="tab">Videos Collection<?php // Here Rob _e( 'FAQs','trav' ); ?></a></li>
								<?php endif ?>
                                <!-- Here Rob
                    ...
                    <!-- Here Rob // Section below is removed See single-trek - Copy.php for original version -->
					<div class="sidebar col-sm-4 col-md-3">
						<?php generated_dynamic_sidebar(); ?>
					</div>   
                    <!-- Here Rob // Section above is removed See single-trek - Copy.php for original version -->                
				</div>
			</div>
		</section><!-- #content -->
<?php endwhile;
