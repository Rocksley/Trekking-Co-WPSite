...
//constants
define( 'TRAV_VERSION', '1.7' );
define( 'TRAV_DB_VERSION', '1.5' );
...
global $wpdb;
define( 'TRAV_TREK_VACANCIES_TABLE', $wpdb->prefix . 'trav_trek_vacancies' );
define( 'TRAV_TREK_BOOKINGS_TABLE', $wpdb->prefix . 'trav_trek_bookings' );
...
require_once( TRAV_INC_DIR . '/frontend/trek/main.php');
